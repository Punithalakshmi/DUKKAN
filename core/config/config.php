...
|
*/
$config['encryption_key'] = 'ORDER123!@#';
...
/* Since this config file is slightly different (it is loaded by CI without using the Config class) */
/* I added here the support for including config.local.php (@crodas) */

if ( ($file=safe_include("config/config_live.php", false)) ) {
    require $file;
}
